    ...
    if (isOpen && messages.length === 0) {
      setTimeout(() => {
        const greeting = currentLanguage === 'hindi'
          ? "नमस्ते! मैं Bani हूं, MaterialMatrix की AI assistant। मैं आपकी construction materials procurement में मदद कर सकती हूं। आप मुझसे कुछ भी पूछ सकते हैं! 😊"
          : "Hello! I'm Bani, your AI assistant from MaterialMatrix. I can help you with construction material procurement. Ask me anything! 😊";
            ...
            <div className="flex items-center justify-between p-4 border-b border-white/10 bg-gradient-ai">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-white/80">MaterialMatrix Procurement Expert</p>
                </div>
              </div>
