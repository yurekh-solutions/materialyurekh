    ...
    if (isOpen && messages.length === 0) {
      setTimeout(() => {
        const greeting = currentLanguage === 'hindi'
          ? "नमस्ते! मैं Bani हूं, आपकी AI procurement assistant। मैं MaterialMatrix के लिए काम करती हूं और आपकी construction materials की जरूरतों में मदद करने के लिए यहां हूं। आप मुझसे किसी भी material के बारे में पूछ सकते हैं - मुझे सब कुछ पता है! कैसे मदद कर सकती हूं?"
          : "Hello! I'm Bani, your AI procurement assistant at MaterialMatrix. I'm here to help you with all your construction material needs.  How can I assist you today?";
