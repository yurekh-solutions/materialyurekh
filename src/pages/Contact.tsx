...
const Contact = () => {
  ...
  const contactMethods = [
    ...
    },
    {
      icon: Mail,
      title: "Email Support",
      value: "info@yurekh.com",
      description: "Detailed inquiries and documentation",
      available: "Response within 1 hour",
      action: "mailto:info@yurekh.com"
    }
  ];
  ...
  const handleSubmit = async (type: string) => {
    ...
    try {
      const emailSubject = encodeURIComponent(
        `${type} Enquiry from ${formData.firstName} ${formData.lastName} - MaterialMatrix`
      );

      let emailBody = `New ${type} Enquiry - MaterialMatrix Contact Form\n\n`;
      ...
      emailBody += `Source: MaterialMatrix Contact Form`;

      const encodedEmailBody = encodeURIComponent(emailBody);
      const emailUrl = `mailto:info@yurekh.com?subject=${emailSubject}&body=${encodedEmailBody}`;
  ...
  const renderFormFields = (tabId: string, type: string) => (
    <div className="space-y-4 md:space-y-6 ">
      ...
      <div className="space-y-2">
        ...
        <Textarea
          id={`message-${tabId}`}
          placeholder={`Please provide details about ${type === "Become a Supplier" ? "your products, services, and business capabilities..." :
  ...
  const structuredData = {
    ...
    "description": "Get in touch with MaterialMatrix for construction material platform, supplier partnerships, and business inquiries",
    "url": "https://MaterialMatrix.com/contact",
    "mainEntity": {
      "@type": "Organization",
      "name": "MaterialMatrix",
      "telephone": "+91-91362-42706",
      "email": "info@yurekh.com"
    }
  };
  ...
  return (
    <>
      <SEOHead
        title="Contact MaterialMatrix - Get in Touch for Construction Material Platform"
        description="Contact MaterialMatrix for construction material platform, supplier partnerships, investor relations, and business inquiries. Quick response within 15 minutes."
        keywords="contact MaterialMatrix, construction materials contact, supplier partnership, investor relations, business inquiry, construction platform support"
