...
import officeBuilding from "../assets/ai-dashboard.jpg";
import constructionSite from "../assets/construction-site.jpg";
import aiDashboard from "../assets/gallery-procurement-ai.jpg";
...
const About = () => {
  ...
  const structuredData = {
    ...
    "logo": "https://MaterialMatrix.com/logo.png",
  ...
  return (
    <>
      <SEOHead
        title="About MaterialMatrix - AI-Powered Procurement Platform"
        description="Learn about MaterialMatrix's mission to revolutionize Procurement with AI technology. Trusted by 1000+ businesses across 20+ states in India."
        keywords="about MaterialMatrix, construction materials, AI procurement, B2B marketplace, construction technology, material suppliers, building materials platform"
                ...
                <GlassCard variant="premium" className="p-6">
                  ...
                  <CardContent className="space-y-4">
                    <p className="text-muted-foreground leading-relaxed">
                      MaterialMatrix is on a mission to transform raw material procurement for the construction industry by leveraging advanced AI and digital innovation. We aim to create a transparent, reliable, and cost-efficient marketplace that bridges global vendors with Indian builders, streamlines sourcing, and empowers businesses to build faster, smarter, and stronger.
                    </p>
              ...
              >
                <div className="space-y-6">
                  <GlassCard variant="premium" className="p-6">
                    ...
                    <CardContent className="space-y-4">
                      <p className="text-muted-foreground leading-relaxed">
                       MaterialMatrix strives to become the world’s leading digital marketplace for construction trade, enabling billions in transactions, fostering sustainable global partnerships, and driving a fully digital, efficient, and eco-conscious procurement ecosystem for the future of infrastructure.
                      </p>
            ...
            <div className="relative container mx-auto px-6 text-center">
              ...
              >
                ...
                <p className="text-lg text-primary-foreground/90 mb-8 max-w-2xl mx-auto leading-relaxed">
                  Join thousands of businesses who trust MaterialMatrix for their 
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  ...
                  <Button
                    onClick={() => handleContactMethod("whatsapp", "https://wa.me/919136242706")}
                    size="lg"
