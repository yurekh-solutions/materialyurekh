    ...
    <div className="min-h-screen bg-background py-10 sm:py-16">
      ...
      <header className="text-center mb-10 sm:mb-16">
        ...
        <p className="text-sm sm:text-base text-muted-foreground max-w-2xl mx-auto leading-relaxed">
          Welcome to MaterialMatrix. Please read these Terms & Conditions carefully as they govern your access to our B2B services and website.
        </p>
      </header>
        ...
        <p className="text-sm sm:text-base text-muted-foreground leading-relaxed">
          ...
          <section>
            ...
            <div className="space-y-1 sm:space-y-2 text-sm sm:text-base text-muted-foreground">
              ...
              <p><strong>Email:</strong> info@yurekh.com</p>
              <p><strong>Phone:</strong> +91 91362 42706</p>
            </div>
          </section>
        </div>
      </main>
