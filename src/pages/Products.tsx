        ...
        <div className="max-w-2xl mx-auto w-full space-y-4 sm:space-y-6 mb-8 sm:mb-12">
          ...
          <div className="relative">
            <Input
              ...
              className="pl-10 sm:pl-12 pr-4 w-full border-gray-600 text-grey-600 placeholder:text-gray-400 focus:border-primary h-11 sm:h-12 text-sm sm:text-base"
            />
              ...
              <Button
                ...
                className={`text-xs sm:text-sm md:text-base ${
                  selectedCategory === category
                    ? "bg-gradient-to-r from-orange-600 via-red-500 to-orange-400 text-white hover:shadow-glow transition-all duration-300 border-none"
                    : " bg-gradient-to-r from-orange-600 via-red-500 to-orange-400 text-white  border-glass-border hover:bg-primary/10 hover:border-primary/20 text-white"
                }`}
              >
                {category}
              </Button>
              ...
              {currentProducts.map((product, index) => (
                ...
                >
                  ...
                  <div className="p-4 sm:p-6 space-y-3 sm:space-y-4">
                    ...
                    <Button 
  size="sm" 
  className="w-full  border-glass-border text-xs sm:text-sm transition-all duration-300
             hover:bg-gradient-to-r hover:from-orange-600 hover:via-red-500 hover:to-orange-400
             hover:text-white hover:border-transparent hover:shadow-[0_0_15px_rgba(255,87,34,0.6)]"
  onClick={() => handleViewProduct(product)}
>
